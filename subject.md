...
-   [x] Structure application as MVC (recommended)
-   [x] Create decent page layout (header, main section, footer)
...
-   [x] Set up containerization (Docker/docker-compose)

### User Features

-   [x] Create user registration form (email, username, password)
-   [ ] Implement email validation for account confirmation
-   [x] Create login/authentication system
-   [ ] Implement password reset functionality
-   [x] Add logout functionality
-   [x] Create user profile editing (username, email, password)
-   [x] Implement password complexity requirements

### Gallery Features

-   [x] Create public gallery page
-   [x] Display all images ordered by creation date
-   [x] Implement like functionality for authenticated users
-   [x] Implement comment functionality for authenticated users
-   [ ] Add email notification for new comments (default enabled)
-   [x] Create user preferences to disable comment notifications
-   [x] Implement pagination (at least 5 images per page)

### Editing Features

-   [x] Create authenticated-only editing page
-   [x] Implement webcam preview functionality
-   [ ] Create list of superposable images
-   [ ] Implement image selection functionality
-   [x] Create capture button (disabled until image selected)
-   [ ] Implement server-side image processing/superposition
-   [x] Add image upload alternative to webcam
-   [x] Create thumbnail gallery of user's previous pictures
-   [x] Implement delete functionality for user's own images

### Database Setup

-   [x] Design database schema (users, images, likes, comments)
-   [x] Create migration scripts
-   [x] Set up database connection

### Security Requirements

-   [x] Implement password hashing (no plain passwords)
-   [ ] Prevent XSS attacks
-   [ ] Prevent SQL injection
-   [x] Implement CSRF protection
-   [x] Validate file uploads
-   [x] Secure environment variables (.env file)
